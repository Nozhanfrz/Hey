...
let proxyIP = "[2606:4700:d0::94cb:d8f1:99ff]";
...
function getVLESSConfig(userID, hostName) {
    ...
    const vlessTlsLink = `vless://${userID}@${hostName}:3854?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2048#${hostName}`
    return `
