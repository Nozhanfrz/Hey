...
function getVLESSConfig(userID, hostName) {
    ...
    const vlessTlsLink = `vless://${userID}@${hostName}:894?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2048#${hostName}`
    return `
